...
scoreboard players set medkits_per_player config 3
scoreboard players set player_max_hp config 8
scoreboard players set hunt_duration config 60
scoreboard players set police_hunt_duration config 90
